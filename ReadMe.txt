...
In order to get this onto your phone, you are going to have to follow these steps.

1. Download project
2. Unzip and place with other Eclipse projects (in your workspace or where ever you want)
3. Open Eclipse and import it as an exisiting project
4. Run the application, pointing it to your phone which is plugged in via USB.

Doing these steps should install the application on your phone.